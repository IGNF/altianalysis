...
def _compute_one_difference(dtm_lhd_file: str,
                            _dir: Path,
                            _out_dir_difference: Path):
...
def compute_all_difference_maps (_dir: Path,
                                 _out_dir_difference: Path):
...
if __name__=="__main__":
    args=parse_args()
    compute_all_difference_maps(args.dtm_lidar_dir,
                                args.name_dir_difference)
